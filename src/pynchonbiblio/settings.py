...
# Django settings for pynchonbiblio project.
...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/martin/workspace/pynchonbiblio/src/sqlite.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '5v^&xa*x@^jsk*r&rkn)b*=^ro3k3_7&_oyy8ic5!ed4^gwcnm'
...
ROOT_URLCONF = 'pynchonbiblio.urls'
